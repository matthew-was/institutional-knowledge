...
6. `documentation/process/development-principles-backend.md` — Repository Pattern, Service Pattern, and Dependency Composition Pattern sections; the backend plan must be consistent with these patterns so the Implementer can follow both documents without conflict
